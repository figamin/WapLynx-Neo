...
hiding.setHideMenu = function(linkSelf) {
  ...
  parentNode.insertBefore(hideButton, parentNode.childNodes[0]);
  ...
  hideButton.onclick = function() {
    ...
    hideMenu.className = 'floatingMenu hideMenu fa-regular fa-square-minus';
